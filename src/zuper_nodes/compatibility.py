...
def check_compatible_protocol(p1: InteractionProtocol, p2: InteractionProtocol):
    ...
    try:
        ...
        if p1_needs_more:
            ...
            raise IncompatibleProtocol(msg, p1_inputs=sorted(p1.inputs), p2_inputs=sorted(p2.inputs), p1_needs_more=p1_needs_more)
        ...
        for k in common_inputs:
            ...
            if not r:
                ...
                raise IncompatibleProtocol(msg, k=k, v1=v1, v2=v2, r=r, p1_inputs=p1.inputs, p2_inputs=p2.inputs)
        ...
        for k in common_ouputs:
            ...
            if not r:
                ...
                raise IncompatibleProtocol(msg, k=k, v1=v1, v2=v2, r=r, p1_outputs=p1.outputs, p2_outputs=p2.outputs)
            # XXX: to finish
